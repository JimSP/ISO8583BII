package br.com.am53.cafebinario.iso8583.file;
...
/**
 * <code>FileReader</code> Interface to represent a feature file read
 * 
...
public interface FileReader {
	 ...
	 * 
	 * @throws IOException
	 *             - If a problem occurs when opening the file set
	 */
	 ...
	 * 
	 * @throws IOException
	 *             - If a problem occurs when closing the file set
	 */
	 ...
	 * @throws IOException
	 *             - If a problem occurs when reading the file set
	 */
	 ...
	 * 
	 * @param fileName
	 *            - the absolute file name for build File
	 */
