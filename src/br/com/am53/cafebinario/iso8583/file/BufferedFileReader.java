 ...
 */
public class BufferedFileReader implements br.com.am53.cafebinario.iso8583.file.FileReader {
	...
	public String nextLine() throws IOException {
		if (file != null && bufferReader != null & fileReader != null) {
			...
			throw new FileNotFoundException(
					"No files were found for reading. Set a file before reading the file!");
		}
	}
